...
const InstagramFilters = () => {
  return (
    <a
      href="https://www.instagram.com/ar/776780867244361"
      target="_blank"
      rel="noopener noreferrer"
      className="mt-20 w-[486px] bg-primary-medium rounded-[20px] border border-1 border-grey-light py-4 md:px-10 cursor-pointer"
    >
